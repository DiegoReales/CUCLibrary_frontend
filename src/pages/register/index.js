        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              <CustomTextField autoFocus fullWidth sx={{ mb: 4 }} label='Nombres' placeholder='john' />
              <CustomTextField fullWidth sx={{ mb: 4 }} label='Apellidos' placeholder='doe' />
              <CustomTextField fullWidth label='Correo Electrónico' sx={{ mb: 4 }} placeholder='johndoe@example.com' />
              <CustomTextField
                fullWidth
                label='Contraseña'
